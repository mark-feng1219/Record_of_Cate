...
def insert_note_comment():
    ...
    comment.comment_id = request.json.get('comment_id')
    comment.comment_publisher_id = request.json.get('comment_publisher_id')
    comment.comment_publish_time = datetime.now()
    comment.comment_content = request.json.get('comment_content')
    comment.publishAt_note_id = request.json.get('publishAt_note_id')
